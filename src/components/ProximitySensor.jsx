...
const ProximitySensor = () => {
	return (
		<aside className="main">
			...
			<div id="eyes">
				<img src={Eye} alt="Eye" className="eye" style={{ top: '57px', right: '20px' }} />
				<img src={Eye} alt="Eye" className="eye" style={{ top: '66px', right: '78px' }} />
				<img src={Eye} alt="Eye" className="eye" style={{ bottom: '54px', left: '104px' }} />
				<img src={Eye} alt="Eye" className="eye" style={{ bottom: '52px', left: '48px' }} />
			</div>
		</aside>
	)
}
